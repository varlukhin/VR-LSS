...
template<> VREXPANSIONPLUGIN_API UScriptStruct* StaticStruct<FRepAttachmentWithWeld>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PluginExpProject_Plugins_VRExpansionPlugin_VRExpansionPlugin_Source_VRExpansionPlugin_Public_Grippables_GrippableDataTypes_h_Statics::ScriptStructInfo[] = {
		{ FRepAttachmentWithWeld::StaticStruct, Z_Construct_UScriptStruct_FRepAttachmentWithWeld_Statics::NewStructOps, TEXT("RepAttachmentWithWeld"), &Z_Registration_Info_UScriptStruct_RepAttachmentWithWeld, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRepAttachmentWithWeld), 991087935U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PluginExpProject_Plugins_VRExpansionPlugin_VRExpansionPlugin_Source_VRExpansionPlugin_Public_Grippables_GrippableDataTypes_h_637732151(TEXT("/Script/VRExpansionPlugin"),
		nullptr, 0,
