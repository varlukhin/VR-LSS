...
// End Cross Module References
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_AVRBasePlayerController_OnCameraManagerCreated_Statics::NewProp_CameraManager = { "CameraManager", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(VRBasePlayerController_eventOnCameraManagerCreated_Parms, CameraManager), Z_Construct_UClass_APlayerCameraManager_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AVRBasePlayerController_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AVRBasePlayerController_OnCameraManagerCreated, "OnCameraManagerCreated" }, // 3509746667
	};
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AVRPlayerController_Statics::NewProp_bDisableServerUpdateCamera = { "bDisableServerUpdateCamera", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(AVRPlayerController), &Z_Construct_UClass_AVRPlayerController_Statics::NewProp_bDisableServerUpdateCamera_SetBit, METADATA_PARAMS(Z_Construct_UClass_AVRPlayerController_Statics::NewProp_bDisableServerUpdateCamera_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AVRPlayerController_Statics::NewProp_bDisableServerUpdateCamera_MetaData)) };
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UVRLocalPlayer_Statics::NewProp_OverridePendingLevelPlayerControllerClass = { "OverridePendingLevelPlayerControllerClass", nullptr, (EPropertyFlags)0x0014000000010015, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UVRLocalPlayer, OverridePendingLevelPlayerControllerClass), Z_Construct_UClass_UClass, Z_Construct_UClass_APlayerController_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UVRLocalPlayer_Statics::NewProp_OverridePendingLevelPlayerControllerClass_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UVRLocalPlayer_Statics::NewProp_OverridePendingLevelPlayerControllerClass_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PluginExpProject_Plugins_VRExpansionPlugin_VRExpansionPlugin_Source_VRExpansionPlugin_Public_VRPlayerController_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AVRBasePlayerController, AVRBasePlayerController::StaticClass, TEXT("AVRBasePlayerController"), &Z_Registration_Info_UClass_AVRBasePlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AVRBasePlayerController), 2142017440U) },
		{ Z_Construct_UClass_AVRPlayerController, AVRPlayerController::StaticClass, TEXT("AVRPlayerController"), &Z_Registration_Info_UClass_AVRPlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AVRPlayerController), 3228663924U) },
		{ Z_Construct_UClass_UVRLocalPlayer, UVRLocalPlayer::StaticClass, TEXT("UVRLocalPlayer"), &Z_Registration_Info_UClass_UVRLocalPlayer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVRLocalPlayer), 1543476990U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PluginExpProject_Plugins_VRExpansionPlugin_VRExpansionPlugin_Source_VRExpansionPlugin_Public_VRPlayerController_h_3443680516(TEXT("/Script/VRExpansionPlugin"),
