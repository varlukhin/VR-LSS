...
template<> OPENXREXPANSIONPLUGIN_API UScriptStruct* StaticStruct<FAnimNode_ApplyOpenXRHandPose>()
{
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FAnimNode_ApplyOpenXRHandPose_Statics::NewProp_SkeletonType = { "SkeletonType", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FAnimNode_ApplyOpenXRHandPose, SkeletonType), Z_Construct_UEnum_OpenXRExpansionPlugin_EVROpenXRSkeletonType, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_ApplyOpenXRHandPose_Statics::NewProp_SkeletonType_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_ApplyOpenXRHandPose_Statics::NewProp_SkeletonType_MetaData)) }; // 1486843990
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAnimNode_ApplyOpenXRHandPose_Statics::NewProp_bSkipRootBone = { "bSkipRootBone", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(FAnimNode_ApplyOpenXRHandPose), &Z_Construct_UScriptStruct_FAnimNode_ApplyOpenXRHandPose_Statics::NewProp_bSkipRootBone_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_ApplyOpenXRHandPose_Statics::NewProp_bSkipRootBone_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_ApplyOpenXRHandPose_Statics::NewProp_bSkipRootBone_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAnimNode_ApplyOpenXRHandPose_Statics::NewProp_bOnlyApplyWristTransform = { "bOnlyApplyWristTransform", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(FAnimNode_ApplyOpenXRHandPose), &Z_Construct_UScriptStruct_FAnimNode_ApplyOpenXRHandPose_Statics::NewProp_bOnlyApplyWristTransform_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_ApplyOpenXRHandPose_Statics::NewProp_bOnlyApplyWristTransform_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_ApplyOpenXRHandPose_Statics::NewProp_bOnlyApplyWristTransform_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnimNode_ApplyOpenXRHandPose_Statics::NewProp_OptionalStoredActionInfo = { "OptionalStoredActionInfo", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FAnimNode_ApplyOpenXRHandPose, OptionalStoredActionInfo), Z_Construct_UScriptStruct_FBPOpenXRActionSkeletalData, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_ApplyOpenXRHandPose_Statics::NewProp_OptionalStoredActionInfo_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_ApplyOpenXRHandPose_Statics::NewProp_OptionalStoredActionInfo_MetaData)) }; // 2860319167
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnimNode_ApplyOpenXRHandPose_Statics::NewProp_MappedBonePairs = { "MappedBonePairs", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FAnimNode_ApplyOpenXRHandPose, MappedBonePairs), Z_Construct_UScriptStruct_FBPOpenXRSkeletalMappingData, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_ApplyOpenXRHandPose_Statics::NewProp_MappedBonePairs_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_ApplyOpenXRHandPose_Statics::NewProp_MappedBonePairs_MetaData)) }; // 1046825536
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PluginExpProject_Plugins_VRExpansionPlugin_OpenXRExpansionPlugin_Source_OpenXRExpansionPlugin_Public_AnimNode_ApplyOpenXRHandPose_h_Statics::ScriptStructInfo[] = {
		{ FAnimNode_ApplyOpenXRHandPose::StaticStruct, Z_Construct_UScriptStruct_FAnimNode_ApplyOpenXRHandPose_Statics::NewStructOps, TEXT("AnimNode_ApplyOpenXRHandPose"), &Z_Registration_Info_UScriptStruct_AnimNode_ApplyOpenXRHandPose, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNode_ApplyOpenXRHandPose), 1799460169U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PluginExpProject_Plugins_VRExpansionPlugin_OpenXRExpansionPlugin_Source_OpenXRExpansionPlugin_Public_AnimNode_ApplyOpenXRHandPose_h_3526014141(TEXT("/Script/OpenXRExpansionPlugin"),
		nullptr, 0,
